...
export const projects = [
  ...
  },
  {
    ...
    des: "Developed an end-to-end event booking platform with JWT auth, Cloudinary media uploads, Ant Design interfaces, Paystack payments, and optimistic locking to prevent duplicate bookings during high-demand purchase flows.",
    img: "/ew.png",
    iconLists: ["/re.svg", "/node.svg", "/mongo.svg", "/express.svg", "/cloud.svg"],
